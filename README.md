...
一个可爱的桌面伙伴，能够通过本地大模型与你进行自然语言交流。
---

本项目提供全自动环境配置脚本，但不推荐直接 Clone 使用，因为需要自行解决环境和模型相关的配置。推荐下载打包好的整合版：
[通过百度网盘下载](https://pan.baidu.com/s/175ce9QOyGaF6nZ-UwPUjLw) 提取码: 1895
[通过夸克网盘下载](https://pan.quark.cn/s/86f621ba2ea8
) 提取码：Z5cd
...
如果通过GitHub下载，首次运行之前请依次执行三个步骤，如果下载网盘版本，可以直接执行第三步。
...
### 2. 下载模型
双击运行 **`download_model.bat`**。
- 脚本会自动下载推荐的模型 (Qwen1.5-0.5B-Chat, 约400MB) 到 `modle/` 目录。
- **或者**：你也可以手动下载任意 GGUF 格式的大语言模型（例如 `qwen1_5-0_5b-chat-q4_k_m.gguf`），并将其放置在 **`modle/`** 文件夹下。
